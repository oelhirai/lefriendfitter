...
public class DogTheme extends Activity implements View.OnClickListener {
	int curIndex = 0;
	Bitmap bmp;
	int[] imagesToShow = { R.drawable.d_1, R.drawable.d_2, R.drawable.d_3,
			               R.drawable.d_4, R.drawable.d_5 };
